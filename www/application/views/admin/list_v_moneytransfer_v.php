<? if (isset($province)):
    ...
    <table style="text-align: right" class="tblist">
        <thead>
        <tr><td>ID</td><td>Ngày</td><td>Từ Cửa hàng </td><td>Đến Cửa hàng </td><td>Đối tượng </td></td><td>Thanh toán </td><td>Loại tiền</td><td>Mã HĐ</td><td>Loại</td><td>Ghi chú</td></tr>
        </thead>

...
AS
SELECT s.id,
SUM(CASE WHEN (t.pgtype='nhap' AND t.inoutxuattype is NULL) THEN (t.pgamount) ELSE 0 END) tiennhap,
SUM(CASE WHEN (t.pgtype='xuat' AND t.inoutxuattype is NULL ) THEN (t.pgamount) ELSE 0 END) tienxuat,

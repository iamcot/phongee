...
AS
SELECT m1.pgdate,m1.pginfo,m1.pgtype,m1.pgamount,
0 AS inout_id,m1.pgcreateuser_id,m1.pgstore_id,
m1.inoutfrom,m1.inoutto,m1.inouttype,m1.inoutxuattype
FROM v_moneytransfer m1
WHERE m1.pgdeleted=0 AND m1.pginout_id=0
UNION ALL
SELECT m2.pgdate,m2.pginfo,m2.pgtype,m2.pgamount,
i.id,m2.pgcreateuser_id,m2.pgstore_id,
m2.inoutfrom,m2.inoutto,m2.inouttype,m2.inoutxuattype
